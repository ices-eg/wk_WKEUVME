...
# script for spatial data grid Greater North Sea
...
# assign area of interest
  gt<-(GridTopology(c(-16.975, 48.025), c(0.05, 0.05), c(600, 300))) # c(long, lat), c(cellsize long, lat), c(nb of grids long, lat)
...
# assign EEZ
  ...
  bargrid <- subset(bargrid,bargrid@data$EcReg =="Greater North Sea")
  ...
  save(Northsea, file="Greater_North_Sea_region.RData")
